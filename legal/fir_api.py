...
def get_pending_cases():
    ...
    try:
        ...
        # Get cases from last 30 days that are still under investigation
        ...
        # Analyze which cases need attention
        pending_cases = []
            ...
            if case_analysis.get('needs_attention', True):
                pending_cases.append({
                    **case,
                    ...
                    'days_pending': (datetime.now() - datetime.fromisoformat(case['created_at'])).days
                })
...
def get_case_updates():
    ...
    try:
        ...
        # Get cases with recent activity (last 7 days)
